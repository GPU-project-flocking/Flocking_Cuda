...
for i in {1..10}
do 
./flockPar 10000 1000 >> ./output.txt
printf "\n" >> ./output.txt
done
echo "50000 boid"
...
for i in {1..10}
do 
./flockPar 50000 1000 >> ./output.txt
printf "\n" >> ./output.txt
done
echo "100000 boid"
...
for i in {1..10}
do 
./flockPar 100000 1000 >> ./output.txt
printf "\n" >> ./output.txt
done
echo "500000 boid"
...
for i in {1..10}
do 
./flockPar 500000 1000 >> ./output.txt
printf "\n" >> ./output.txt
done
